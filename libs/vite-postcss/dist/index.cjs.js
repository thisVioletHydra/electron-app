...
// ../../node_modules/.pnpm/tsup@8.3.5_@microsoft+api-extractor@7.47.11_@types+node@22.9.0__jiti@2.3.3_postcss@8.4.48_tsx_dm736rusbtjq7bsypwcstiz4xu/node_modules/tsup/assets/cjs_shims.js
...
var require_pixel_unit_regex = __commonJS({
  "../../node_modules/.pnpm/postcss-pxtorem@6.1.0_postcss@8.4.48/node_modules/postcss-pxtorem/lib/pixel-unit-regex.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
...
var require_filter_prop_list = __commonJS({
  "../../node_modules/.pnpm/postcss-pxtorem@6.1.0_postcss@8.4.48/node_modules/postcss-pxtorem/lib/filter-prop-list.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    module2.exports = {
...
var require_type = __commonJS({
  "../../node_modules/.pnpm/postcss-pxtorem@6.1.0_postcss@8.4.48/node_modules/postcss-pxtorem/lib/type.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
...
var require_postcss_pxtorem = __commonJS({
  "../../node_modules/.pnpm/postcss-pxtorem@6.1.0_postcss@8.4.48/node_modules/postcss-pxtorem/index.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
...
var require_layerCache = __commonJS({
  "../../node_modules/.pnpm/postcss-zindex@7.0.0_postcss@8.4.48/node_modules/postcss-zindex/src/lib/layerCache.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    function LayerCache() {
    ...
    module2.exports = LayerCache;
  }
});

// ../../node_modules/.pnpm/postcss-zindex@7.0.0_postcss@8.4.48/node_modules/postcss-zindex/src/index.js
var require_src = __commonJS({
  "../../node_modules/.pnpm/postcss-zindex@7.0.0_postcss@8.4.48/node_modules/postcss-zindex/src/index.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
...
function parseImport(t6, o5, a5, n3) {
  ...
  try {
    if (a5.startsWith("node_modules://")) {
      c4 = import_node_module.default.createRequire(process.cwd()).resolve(a5.slice(15));
    } else if (a5.startsWith("node_modules:")) {
      c4 = import_node_module.default.createRequire(process.cwd()).resolve(a5.slice(13));
    } else c4 = import_node_path.default.resolve(a5);
  } catch (e7) {
  ...
  const l4 = import_node_fs.default.readFileSync(c4, "utf8");
...
function rebase(e7, r6, t6) {
  ...
  const s5 = import_node_path2.default.posix.resolve(import_node_path2.default.posix.join(r6, e7));
  return import_node_path2.default.posix.relative(t6, s5);
}
...
function normalizedDir(e7) {
  return import_node_path2.default.parse(import_node_path2.default.resolve(e7.trim())).dir.split(import_node_path2.default.sep).join(import_node_path2.default.posix.sep);
}
...
var creator2 = () => ({ postcssPlugin: "postcss-rebase-url", prepare() {
  ...
  return { postcssPlugin: "postcss-rebase-url", Once(e7) {
    ...
    if (!$) return;
    const k = normalizedDir($), z = (0, import_css_parser_algorithms.parseCommaSeparatedListOfComponentValues)((0, import_css_tokenizer.tokenize)({ css: m4.value })), x = (0, import_css_parser_algorithms.replaceComponentValues)(z, (e7) => {
      if ((0, import_css_parser_algorithms.isTokenNode)(e7) && (0, import_css_tokenizer.isTokenURL)(e7.value)) {
        const r6 = rebase(e7.value[4].value.trim(), k, S);
        if (r6) return e7.value[4].value = r6, e7.value[1] = `url(${serializeString(r6)})`, e7;
      }
      if ((0, import_css_parser_algorithms.isFunctionNode)(e7) && b.test(e7.getName())) {
        for (const r6 of e7.value) if (!(0, import_css_parser_algorithms.isWhitespaceNode)(r6) && !(0, import_css_parser_algorithms.isCommentNode)(r6) && (0, import_css_parser_algorithms.isTokenNode)(r6) && (0, import_css_tokenizer.isTokenString)(r6.value)) {
          const t6 = rebase(r6.value[4].value.trim(), k, S);
          if (t6) return r6.value[4].value = t6, r6.value[1] = `"${serializeString(t6)}"`, e7;
          break;
        }
      }
    }), w2 = (0, import_css_parser_algorithms.stringify)(x);
...
var creator5 = (a5) => {
  ...
  return { postcssPlugin: "postcss-color-hex-alpha", Declaration(a6) {
    ...
    const { value: l4 } = a6, n3 = (0, import_postcss_value_parser.default)(l4);
    n3.walk((e7) => {
...
// src/index.ts
var import_postcss_css_variables = __toESM(require("postcss-css-variables"), 1);
...
var import_css_parser_algorithms2 = require("@csstools/css-parser-algorithms");
var LayerName = class _LayerName {
  ...
  slice(t6, r6) {
    const n3 = [];
    for (let t7 = 0; t7 < this.parts.length; t7++) (0, import_css_tokenizer2.isTokenIdent)(this.parts[t7]) && n3.push(t7);
    const a5 = n3.slice(t6, r6);
    return new _LayerName(this.parts.slice(a5[0], a5[a5.length - 1] + 1));
  }
  concat(n3) {
    const a5 = [import_css_tokenizer2.TokenType.Delim, ".", -1, -1, { value: "." }];
    return new _LayerName([...this.parts.filter((t6) => (0, import_css_tokenizer2.isTokenIdent)(t6) || (0, import_css_tokenizer2.isTokenDelim)(t6)), a5, ...n3.parts.filter((t6) => (0, import_css_tokenizer2.isTokenIdent)(t6) || (0, import_css_tokenizer2.isTokenDelim)(t6))]);
  }
  segments() {
    return this.parts.filter((t6) => (0, import_css_tokenizer2.isTokenIdent)(t6)).map((e7) => e7[4].value);
  }
  name() {
    return this.parts.filter((t6) => (0, import_css_tokenizer2.isTokenIdent)(t6) || (0, import_css_tokenizer2.isTokenDelim)(t6)).map((e7) => e7[1]).join("");
  }
  equal(e7) {
  ...
  toString() {
    return (0, import_css_tokenizer2.stringify)(...this.parts);
  }
  toJSON() {
...
function parseFromTokens(t6, n3) {
  const o5 = (0, import_css_parser_algorithms2.parseCommaSeparatedListOfComponentValues)(t6, { onParseError: n3?.onParseError }), f3 = n3?.onParseError ?? (() => {
  ...
  for (let t7 = 0; t7 < o5.length; t7++) {
    ...
    for (let e7 = 0; e7 < n4.length; e7++) {
      const t8 = n4[e7];
      if (!(0, import_css_parser_algorithms2.isTokenNode)(t8) && !(0, import_css_parser_algorithms2.isCommentNode)(t8) && !(0, import_css_parser_algorithms2.isWhitespaceNode)(t8)) return f3(new import_css_tokenizer2.ParseError(`Invalid cascade layer name. Invalid layer name part "${t8.toString()}"`, d3, y, h2)), [];
    }
    const c4 = n4.flatMap((e7) => e7.tokens());
    let w2 = false, v3 = false, L = null;
    for (let t8 = 0; t8 < c4.length; t8++) {
      const n5 = c4[t8];
      if (!((0, import_css_tokenizer2.isTokenWhiteSpaceOrComment)(n5) || (0, import_css_tokenizer2.isTokenIdent)(n5) || (0, import_css_tokenizer2.isTokenDelim)(n5) && "." === n5[4].value)) return f3(new import_css_tokenizer2.ParseError(`Invalid cascade layer name. Invalid character "${n5[1]}"`, d3, y, h2)), [];
      if (!w2 && (0, import_css_tokenizer2.isTokenDelim)(n5)) return f3(new import_css_tokenizer2.ParseError("Invalid cascade layer name. Layer names can not start with a dot.", d3, y, h2)), [];
      if (w2) {
        if ((0, import_css_tokenizer2.isTokenWhitespace)(n5)) {
          v3 = true;
          continue;
        }
        if (v3 && (0, import_css_tokenizer2.isTokenComment)(n5)) continue;
        if (v3) return f3(new import_css_tokenizer2.ParseError("Invalid cascade layer name. Encountered unexpected whitespace between layer name parts.", d3, y, h2)), [];
        if ((0, import_css_tokenizer2.isTokenIdent)(L) && (0, import_css_tokenizer2.isTokenIdent)(n5)) return f3(new import_css_tokenizer2.ParseError("Invalid cascade layer name. Layer name parts must be separated by dots.", d3, y, h2)), [];
        if ((0, import_css_tokenizer2.isTokenDelim)(L) && (0, import_css_tokenizer2.isTokenDelim)(n5)) return f3(new import_css_tokenizer2.ParseError("Invalid cascade layer name. Layer name parts must not be empty.", d3, y, h2)), [];
      }
      (0, import_css_tokenizer2.isTokenIdent)(n5) && (w2 = true), ((0, import_css_tokenizer2.isTokenIdent)(n5) || (0, import_css_tokenizer2.isTokenDelim)(n5)) && (L = n5);
    }
    if (!L) return f3(new import_css_tokenizer2.ParseError("Invalid cascade layer name. Empty layer name.", d3, y, h2)), [];
    if ((0, import_css_tokenizer2.isTokenDelim)(L)) return f3(new import_css_tokenizer2.ParseError("Invalid cascade layer name. Layer name must not end with a dot.", d3, y, h2)), [];
    g3.push(new LayerName(c4));
  }
  return g3;
}
function parse(e7, t6) {
  return parseFromTokens((0, import_css_tokenizer2.tokenize)({ css: e7 }, { onParseError: t6?.onParseError }), t6);
}

// ../../node_modules/.pnpm/postcss-custom-properties@14.0.4_postcss@8.4.48/node_modules/postcss-custom-properties/dist/index.mjs
var import_postcss_value_parser2 = __toESM(require("postcss-value-parser"), 1);
...
function parseOrCached(e7, t6) {
  let n3 = t6.get(e7);
  return n3 || (n3 = (0, import_postcss_value_parser2.default)(e7), t6.set(e7, n3), n3);
}
...
function transformValueAST(e7, t6) {
  return e7.nodes?.length ? (walk(e7.nodes, (e8, n3, o5) => {
    ...
    if (!s5) return;
    let a5 = false;
    s5.fallback && import_postcss_value_parser2.default.walk(s5.fallback, (e9) => {
  ...
  }), import_postcss_value_parser2.default.stringify(e7.nodes)) : "";
}
function walk(e7, t6) {
  let r6, n3, o5;
...
function buildCustomPropertiesMap(e7, t6, n3) {
  ...
  const o5 = new Map(t6);
  {
    ...
    for (const [a5, i4] of e7.entries()) {
      ...
      let c4 = false;
      import_postcss_value_parser2.default.walk(l4.nodes, (r6) => {
  ...
  {
    const e8 = [];
    for (const [t8, n4] of o5.entries()) import_postcss_value_parser2.default.walk(n4.nodes, (r6) => {
      if (!isVarFunction(r6)) return;
...
function transformProperties(e7, t6, n3) {
  if (isTransformableDecl(e7) && !isDeclarationIgnored(e7)) {
    const o5 = e7.value, s5 = transformValueAST((0, import_postcss_value_parser2.default)(o5), t6);
    if (s5 === o5) return;
...
// src/index.ts
var import_postcss_import = __toESM(require("postcss-import"), 1);
var import_postcss_lightningcss = __toESM(require("postcss-lightningcss"), 1);
...
init_cjs_shims();
var import_postcss_value_parser3 = __toESM(require("postcss-value-parser"), 1);
function onCSSDeclaration(o5, r6, s5) {
  const n3 = o5.prop.match(t5)?.[1].toLowerCase();
  if (!n3) return;
  let a5;
  try {
    a5 = (0, import_postcss_value_parser3.default)(o5.value);
  } catch {
    o5.warn(r6, `Failed to parse value '${o5.value}'. Leaving the original value intact.`);
  }
  if (void 0 === a5) return;
  let i4 = [];
  i4 = a5.nodes.length ? a5.nodes.filter((e7) => "word" === e7.type || "function" === e7.type).map((t6) => import_postcss_value_parser3.default.stringify(t6)) : [import_postcss_value_parser3.default.stringify(a5.nodes)], o5.cloneBefore({ prop: `align-${n3}`, value: i4[0] }), o5.cloneBefore({ prop: `justify-${n3}`, value: i4[1] || i4[0] }), s5.preserve || o5.remove();
}
...
var import_postcss_reporter = __toESM(require("postcss-reporter"), 1);
var import_postcss_sort_media_queries = __toESM(require("postcss-sort-media-queries"), 1);
var import_postcss_zindex = __toESM(require_src(), 1);
function customVariablesMixin(customVariables) {
  switch (customVariables) {
    case "cssVariables": {
      return (0, import_postcss_css_variables.default)({ preserve: true });
    }
...
function nanoMixin(hardParser) {
  switch (hardParser?.name) {
    ...
    case "lightning": {
      return (0, import_postcss_lightningcss.default)(
        {
...
var classicPostcss = ({
  ...
  let plugins = [];
  const production = [(0, import_postcss_sort_media_queries.default)({ sort: "desktop-first" })];
  const development = [
    state(speedTest, creator3()),
    nanoMixin(hardParser),
    state(imports, (0, import_postcss_import.default)()),
    state(nested, (0, import_postcss_nested.default)()),
    ...
    state(reporter, (0, import_postcss_reporter.default)())
  ];
